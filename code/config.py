...
docred_data_dir = '../data/'
fin_data_dir = '../findata/'
data_dir = docred_data_dir
...
def get_opt():
    ...
    parser.add_argument('--use_entity_type', default='True')
    ...
    parser.add_argument('--use_entity_id', default='True')
    ...
    parser.add_argument('--gcn_dim', type=int, default=808)  # 808
